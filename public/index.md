...
Canonieke pagina: <https://wiedoethet.nl/>

## Zo werkt het

1. **Maak een groep.** Geef je groep een naam en voeg de taken toe die verdeeld moeten worden.
...
- **Wie pakt wat.** Bekijk in één oogopslag wie welke taak heeft gepakt. Geen dubbele toewijzingen.
- **Jij bepaalt wie ziet wat.** Kies zelf wie de scorekaart mag bekijken — alleen jij, of iedereen.
...
### Kan ik taken verdelen via WhatsApp?

Na het aanmaken van een takenlijst genereer je een deellink die je rechtstreeks in
je WhatsApp-groep plakt. Deelnemers openen de link en claimen hun taak zonder
extra app of account.

## Voor agents

- [Agentgids](https://wiedoethet.nl/agents.md)
- [Inloggen](https://wiedoethet.nl/auth.md)
- [llms.txt-index](https://wiedoethet.nl/llms.txt)
- [Alle context in één bestand](https://wiedoethet.nl/llms-full.txt)
